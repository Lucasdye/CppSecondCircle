...
{
	std::cout << "Parametric constructor called for AForm" << std::endl;
	return ;
}

AForm::AForm(AForm const & src): _name(""), _isSigned(false), _signGrade(1), _execGrade(1)
{
...
//AForm::AForm(AForm const & src): _name(""), _isSigned(0), _signGrade(1), _execGrade(1)
// {
// 	std::cout << "Copy constructor called for AForm" << std::endl;
// 	*this = src;
// 	return ;
