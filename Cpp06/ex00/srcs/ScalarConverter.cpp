...
/*   Updated: 2024/05/13 10:52:57 by lbouguet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	//std::cout << RED << "nb long double representation: " << std::fixed  << std::setprecision(8) << nb << END_C << std::endl; 
	...
	else if (nb < std::numeric_limits<float>::min())
		std::cout << "float: " << "-inff"<< std::endl;
	else
	{	
	...
	else if (nb < std::numeric_limits<double>::min())
		std::cout << "double: " << "-inf"<< std::endl;
	else
	{
